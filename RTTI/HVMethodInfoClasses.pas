...
type
  ...
  proc_rva = function (adr:Cardinal):Pointer of object; // convert RVA into VA

procedure GetClassInfo(ClassTypeInfo: PTypeInfo; var ClassInfo: TClassInfo; conv:proc_rva);
...
begin
  ...
  ClassInfo.ClassType       := conv(Cardinal(TypeData.ClassType));
  ClassInfo.Name            := ClassInfo.ClassType.ClassName;
  ClassInfo.ParentClass     := ClassOfTypeInfo(conv(Cardinal(TypeData.ParentInfo)));
