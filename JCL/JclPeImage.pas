...
type
  ...
  public
    constructor Create(AImportLib: TJclPeImportLibItem; AOrdinal: Word;
      AHint: Word; const AName: string; ARVA:Pointer);
    property Ordinal: Word read FOrdinal;
    property Hint: Word read FHint;
    property RVA: Pointer read FRVA;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net/svnroot/jcl/tags/JCL-1.102-Build3072/jcl/source/windows/JclPeImage.pas $';
...
constructor TJclPeImportFuncItem.Create(AImportLib: TJclPeImportLibItem;
  AOrdinal: Word; AHint: Word; const AName: string; ARVA: Pointer);
begin
  inherited Create;
...
procedure TJclPeImportLibItem.CreateList;
  ...
  begin
    ...
    begin
      ...
      Add(TJclPeImportFuncItem.Create(Self, Ordinal, Hint, Name, {@OrdinalName.Hint} Thunk32)); // IVO GELOV
      Inc(Thunk32);
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      Add(TJclPeImportFuncItem.Create(Self, Ordinal, Hint, Name, @OrdinalName.Hint));
      Inc(Thunk64);
    end;
  end;
begin
